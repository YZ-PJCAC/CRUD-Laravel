...
<main class="d-flex flex-nowrap h-100">
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="{{ route('student.index') }}" class="nav-link text-white">
          <svg class="bi pe-none me-2" width="16" height="16" fill="white" fill="white"><use xlink:href="#speedometer2"/></svg>
          Students
        </a>
      </li>
      <li>
        <a href="{{ route('course.index') }}" class="nav-link text-white">
          <svg class="bi pe-none me-2" width="16" height="16" fill="white"><use xlink:href="#table"/></svg>
          Courses
        </a>
      </li>
      <li>
        <a href="{{ route('examination.index') }}" class="nav-link text-white">
            <svg class="bi bi-file-earmark-check-fill" width="16" height="16" fill="currentColor" ><use xlink:href="#doc"/></svg>
            Examination
          </a>
      </li>
    </ul>
    ...
    <div >
        ...
        <strong>Signout</strong><a href="#" class="nav-link text-white"></a>
    </div> --}}
  </div>
